...
function getItems(location: string) {
    return [
        ...
        {
            title: 'Expert Carpet And Upholstery Cleaners',
        ...
        },
        {
            ...
            content: `We’ve got insured & vetted carpet and upholstery cleaners across ${location}, ready to help get you in getting your home sparkling clean.`,
        },
        {
