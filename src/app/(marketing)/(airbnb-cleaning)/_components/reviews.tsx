...
const getReviews = (location: string) => {
    return [
        ...
        {
            name: 'Melanie',
            body: `I've used Coast Maid twice for bond cleaning, and on both occasions they have been very open and communicative. The cleaning met all my expectations and would recommend them.`,
        },
        {
            name: 'Sarah',
