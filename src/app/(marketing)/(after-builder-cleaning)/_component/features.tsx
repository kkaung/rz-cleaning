...
function getItems(location: string) {
    return [
        ...
        {
            title: 'Expert After Builder Cleaners',
        ...
        },
        {
            ...
            content: `We’ve got insured & vetted construction cleaners across ${location}, ready to help get you in getting your home sparkling clean.`,
        },
        {
